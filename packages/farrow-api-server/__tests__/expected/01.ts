...
export const api = {
  methodA: (input: Collection, options?: ApiBatchLoadOptions) =>
    apiBatchLoader.load({ type: 'Single', path: ['methodA'], input }, options) as Promise<Collection>,
  methodB: (input: Collection, options?: ApiBatchLoadOptions) =>
    apiBatchLoader.load({ type: 'Single', path: ['methodB'], input }, options) as Promise<Collection>,
}